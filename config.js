/* Domluveno — veřejná konfigurace.
   Vyplň po založení Supabase projektu (viz PRODUCTION.md).
   Bez vyplnění běží appka v lokálním demo režimu (localStorage). */
window.DOMLUVENO_CONFIG = {
  ...
  /* Ostrá adresa: https://domluveno.online. Prázdné = aktuální origin. */
     Prázdné = použije se aktuální origin (funguje i na Vercelu). */
